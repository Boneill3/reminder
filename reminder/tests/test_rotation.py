...
class TestRotation:
	...
	def test_rotation_test(self, p: MagicMock):
		"""
	...
	@patch("reminder.main.Client")
	@patch("reminder.rotation.send_sms")
	@patch("reminder.rotation.get_users_by_last_completed_date")
	@mark.skip()
	def test_send_reminder_with_no_users_throws_exception(self, get_users_mock: MagicMock, 
	...
	def test_send_reminder(self, update_user_attempted_mock:MagicMock, get_users_mock: MagicMock, send_sms_mock:MagicMock):
		"""
		...
		update_user_attempted_mock.assert_called_once_with("123", phone_number)
	...
	@patch("reminder.rotation.send_sms")
	def test_recieve_positive_response(self, send_sms:MagicMock, 
	...
	@patch("reminder.rotation.get_user_by_phone_number")
	def test_recieve_from_non_user(self, get_user_by_phone_number:MagicMock):
		'''
	...
	@patch("reminder.rotation.get_user_by_phone_number")
	@patch("reminder.rotation.send_sms")
	def test_recieve_non_valid_response(self, send_sms:MagicMock, 
										get_user_by_phone_number:MagicMock, 
										update_user_response:MagicMock, 
										complete_reminder:MagicMock, 
										reminder_is_active:MagicMock):
	...
	@patch("reminder.rotation.get_user_by_phone_number")
	@patch("reminder.rotation.send_sms")
	def test_recieve_completed_reminder(self, send_sms:MagicMock, 
										get_user_by_phone_number:MagicMock, 
										update_user_response:MagicMock, 
										complete_reminder:MagicMock, 
										reminder_is_active:MagicMock):
	...
	@patch("reminder.rotation.get_user_by_phone_number")
	@patch("reminder.rotation.send_sms")
	def test_recieve_negative_response(self, send_sms:MagicMock, 
									get_user_by_phone_number:MagicMock, 
									update_user_response:MagicMock, 
									complete_reminder:MagicMock, 
									reminder_is_active:MagicMock, 
